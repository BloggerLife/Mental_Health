...
export default function App() {
	const questions = [
		{
			questionText: 'Little or no interest in doing your favourite hobby?',
			answerOptions: [
		...
		{
			questionText: 'Feeling down or hopeless?',
			answerOptions: [
				{ answerText: 'Not at all', isPositive: false },
				{ answerText: 'Less than a week', isPositive: false },
				{ answerText: 'Sometimes', isPositive: true },
		...
		{
			questionText: 'Having trouble falling or staying asleep, or sleeping too much?',
			answerOptions: [
				{ answerText: 'Not at all', isPositive: false },
				{ answerText: 'Less than a week', isPositive: false },
				{ answerText: 'Sometimes', isPositive: true },
		...
		{
			questionText: 'Having poor appetite or over eating?',
			answerOptions: [
				{ answerText: 'Not at all', isPositive: false },
				{ answerText: 'Less than a week', isPositive: false },
				{ answerText: 'Sometimes', isPositive: true },
		...
		{
			questionText: 'Feeling bad about yourself or having negative thoughts?',
			answerOptions: [
				{ answerText: 'Not at all', isPositive: false },
				{ answerText: 'Less than a week', isPositive: false },
				{ answerText: 'Sometimes', isPositive: true },
	...
	const handleAnswerOptionClick = (isPositive) => {
		...
		const decide = () => {
			if (score>= questions.length/2) {
				...
				setRegister(false)
				alert("You have no symptoms of Depression");
			}
		}
